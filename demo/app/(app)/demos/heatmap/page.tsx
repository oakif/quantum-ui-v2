...
const PURPLE_SCALE = [
  "var(--color-muted)",
  "oklch(0.55 0.15 300 / 0.3)",
  "oklch(0.55 0.15 300 / 0.55)",
...
const BLUE_SCALE = [
  ...
  "oklch(0.55 0.12 250 / 0.55)",
  "oklch(0.55 0.12 250 / 0.8)",
  "oklch(0.65 0.18 250)",
]
...
export default function HeatmapDemoPage() {
  ...
  return (
    <div className="flex flex-1 flex-col">
      <PageHeader>
        <PageHeaderHeading>Heatmap</PageHeaderHeading>
        <PageHeaderDescription>
          A calendar heatmap for visualizing activity over time, with discrete and interpolated color modes.
        </PageHeaderDescription>
      </PageHeader>
